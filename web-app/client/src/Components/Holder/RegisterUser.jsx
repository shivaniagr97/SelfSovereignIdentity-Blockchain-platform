...
import PopUp from "./UserPage/PopUp";
...
class RegisterUser extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            address: "B318, New LH, NITW",
            city: "Warangal",
            state: "Telangana",
            pinCode: "506004",
            contact: "9406474464",
            email: "ashivani997@gmail.com",
            spinner: false,
            alertType: "danger",
            alertData: "",
            alertShow: false,
    ...
    handleRegisterUser = async (event) => {
        ...
        if (validateName(event.target.firstName.value) === false) {
            error_string = "First Name of user is Invalid";
        } else if (validateName(event.target.lastName.value) === false) {
            error_string = "Last Name of user is Invalid";
        } else if (validateContact(event.target.contact.value) === false) {
            error_string = "Contact Number is Invalid";
        }
        ...
        console.log("registerHolder called");

        let response = await axios.post(ADDRESS + `registerHolder`, this.state);
        if (response.data === 'Correct') {
            this.setState({
                spinner: false,
                alertShow: true,
                toRedirect: true,
                alertData: "User Successfully Registered",
                alertType: "success",
            });
        } else {
            this.setState({
