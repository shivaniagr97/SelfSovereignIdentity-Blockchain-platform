        ...
        return (
            <div>
                <div className="PageSwitcher">
                    ...
                    <NavLink to="/registerServiceProvider" activeClassName="PageSwitcher__Item--Active"
                ...
                <div className="FormTitle">
                    <NavLink exact to="/" activeClassName="FormTitle__Link--Active" className="FormTitle__Link">Sign
                        In</NavLink> or <NavLink to="/registerServiceProvider" activeClassName="FormTitle__Link--Active"
