                ...
                <div className="FormCenter">
                    <form onSubmit={this.handleSubmit} className="FormFields">
                        ...
                        <div className="FormField">
                            ...
                            <input type="text" id="userID" className="FormField__Input" placeholder="Enter your user ID"
                        ...
                        <div className="FormField">
                            ...
                            <input type="date" id="dateOfBirth" className="FormField__Input"
                                   ...
                                   name="dateOfBirth" value={this.state.dateOfBirth} onChange={this.handleChange}/>
                        </div>
                        <div className="FormField">
                        ...
                        <div className="FormField">
                            ...
                            <input type="city" id="city" className="FormField__Input" placeholder="Enter your city"
                                   name="city" value={this.state.city} onChange={this.handleChange}/>
                        </div>
                        <div className="FormField">
                            <label className="FormField__Label" htmlFor="state">State</label>
                            <input type="state" id="state" className="FormField__Input" placeholder="Enter your state"
